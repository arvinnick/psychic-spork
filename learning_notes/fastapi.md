...
- The settings are made by using “pydentic-settings”  
- You will create a class, inheriting from BaseSettings  
- You will use SettingsConfigDict class to read “.env” file (no yaml)

## Dependency override:

- You do it for testing mainly. You don’t allow the dependencies to be used in certain situations, instead, use your own (maybe mock, maybe hardcoded).  
- `App.dependency_overrides` is a dictionary by which you can do this override.  
- Put everything you want inside the dict within the test function, then assign a clear dictionary at the end of the function so you reset everything.  
...
* You can instantiate the ORM classes.  
* Many to many tables are instances of ORM classes.

- Domain models will not be changed often  
- 